	...
	createSerialGraph: function() {
		...
		for (H = Z; H <= S; H++) {
			...
			if (ta) {
				...
				ma = Math.floor(D / 2) + Math.floor(Ha * D / 2),
				za = ma,
				wb = 0;
				"left" == this.stepDirection && (wb = (2 * D + Ha * D) / 2, ja -= wb);
				"start" == this.pointPosition && (ja -= D / 2 + Math.floor(Ha * D / 2), ma = 0, za = Math.floor(D) + Math.floor(Ha * D));
				...
				case "smoothedLine":
					...
					break;
				case "step":
					isNaN(R) ? u || (v = s = NaN, this.drawLineGraph(q, t, T, U), q = [], t = [], T = [], U = []) : (x.isNegative = R < ea ? !0 : !1, void 0 == x.lineColor && void 0 == x.fillColors && isNaN(x.dashLength) || (this.drawLineGraph(q, t, T, U), q = [], t = [], T = [], U = [], this.lineColorSwitched = x.lineColor, this.fillColorsSwitched = x.fillColors, this.dashLengthSwitched = x.dashLength), n ? (isNaN(v) || (q.push(v), t.push(E - ma)), t.push(E - ma), q.push(F), t.push(E + za), q.push(F), !Na || isNaN(O) || isNaN(Q) || (T.push(w), U.push(O - ma), T.push(Q), U.push(O - ma), T.push(Q), U.push(O + za))) : (isNaN(s) || (t.push(s), q.push(v), t.push(s), q.push(F - ma)), q.push(F - ma), t.push(E), q.push(F + za), t.push(E), !Na || isNaN(O) || isNaN(Q) || (T.push(Q - ma), U.push(A), T.push(Q - ma), U.push(O), T.push(Q + za), U.push(O))), v = F, s = E, w = Q, A = O, ca = F, ga = E, pa = F, qa = E, vb && (v = s = NaN, this.drawLineGraph(q, t, T, U), q = [], t = [], T = [], U = []));
					break;
				case "column":
					la = ra;
					...
					if (!isNaN(R)) {
						...
						if (! (R < xb && ka < xb || R > yb && ka > yb)) if (n) {
							...
							if (N < l && 0 < K && (na = new AmCharts.Cuboid(e, ba, K, z - a.d3x, J - a.d3y, ya, Qa, L, la, V, ha, r, n, Y, Ra), "bottom" != B && "inside" != B && "middle" != B)) if (B = f.reversed ? "left": "right", 0 > R) B = f.reversed ? "right": "left";
							...
							if (M < k + $ * z && 0 < K) if (na = new AmCharts.Cuboid(e, K, ba, z - a.d3x, J - a.d3y, ya, Qa, L, la, this.lineAlpha, ha, r, n, Y, Ra), 0 > R && "middle" != B && "inside" != B) B = "bottom";
					...
					if (!isNaN(ka) && !isNaN(R)) {
						...
						if (n) {
							if (N = E - h / 2, M = Q, K = h, N + K > l && (K = l - N), 0 > N && (K += N, N = 0), N < l && 0 < K) {
								var jb, kb;
								R > ka ? (jb = [F, Pa], kb = [Q, Oa]) : (jb = [Q, Pa], kb = [F, Oa]); ! isNaN(Pa) && !isNaN(Oa) && E < l && 0 < E && ($a = AmCharts.line(e, jb, [E, E], la, V, L), ib = AmCharts.line(e, kb, [E, E], la, V, L));
								ba = F - Q;
							...
							var na = new AmCharts.Cuboid(e, K, ba, z, J, ya, Qa, L, la, V, ha, r, n, Y, Ra),
							lb,
							mb;
							R > ka ? (lb = [E, Ca], mb = [O, Ba]) : (lb = [O, Ca], mb = [E, Ba]); ! isNaN(Ca) && !isNaN(Ba) && F < k && 0 < F && ($a = AmCharts.line(e, [F, F], lb, la, V, L), ib = AmCharts.line(e, [F, F], mb, la, V, L))
						}
					...
					if (this.end - this.start <= Bb || 0 === Bb) {
						...
						if (Cb) {
							...
							case "right":
								...
								break;
							case "bottom":
								n && "column" == g ? (ca = Fa, 0 > R || 0 < R && f.reversed ? (ua = -6, fa.attr({
									"text-anchor": "end"
								})) : (ua = 6, fa.attr({
									"text-anchor": "start"
								}))) : (va = Da / 2 + Ea / 2, fa.x = -(Ia / 2 + 2));
								break;
							case "middle":
			...
			if (p) {
				...
				if (c.mouseIsOver || y || z || this.forceShow) if (this.forceShow = !1, z) {
					...
					if (a != this.previousIndex || B != this.previousMostCloseGraph) if (this.normalizeBulletSize(), this.destroyValueBalloons(), this.resizedBullets = [], J && this.valueBalloonsEnabled && t && c.balloon.enabled) {
						...
						for (w = 0; w < J.length; w++) if (f = J[w], (!this.oneBalloonOnly || f == B) && f.showBalloon && !f.hidden && f.balloonText) {
...
AmCharts.AmCoordinateChart = AmCharts.Class({
	...
	construct: function(a) {
		...
		this.colors = "#ff9600 #FCD202 #B0DE09 #0D8ECF #2A0CD0 #CD0D74 #CC0000 #00CC00 #0000CC #DDDDDD #999999 #333333 #990000".split(" ");
...
AmCharts.AmSlicedChart = AmCharts.Class({
	...
	construct: function(a) {
		...
		this.colors = "#2da4db #ff9600 #FF9E01 #FCD202 #F8FF01 #B0DE09 #04D215 #0D8ECF #0D52D1 #2A0CD0 #8A0CCF #CD0D74 #754DEB #DDDDDD #999999 #333333 #000000 #57032A #CA9726 #990000 #4B0C25".split(" ");
		this.alpha = 1;
		this.groupPercent = 0;
...
AmCharts.AmLegend = AmCharts.Class({
	...
	createEntry: function(a) {
		if (!1 !== a.visibleInLegend) {
			...
			n = 0,
			p = l / 2;
			if (this.useGraphSettings) if (m = a.type, "line" == m || "step" == m || "smoothedLine" == m || "ohlc" == m) this.switchType = void 0,
			g = k.set(),
			...
			k = k.set([g]);
			this.switchable && k.setAttr("cursor", "pointer"); (f = this.switchType) && "none" != f && (r = "x" == f ? this.createX() : this.createV(), r.dItem = a, !0 !== a.hidden ? "x" == f ? r.hide() : r.show() : "x" != f && r.hide(), this.switchable || r.hide(), this.addListeners(r, a), a.legendSwitch = r, k.push(r));
			f = this.color;
