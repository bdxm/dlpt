      ...
      <div class="content-box">
        ...
        <div class="content-main">
          <table width="100%" cellpadding="0" cellspacing="1" border="0" class="box-page">
            ...
            <tfoot>
              <tr height="35">
                <td colspan="8"> 共 <?php echo $Data ['RecordCount'];?> 条记录，每页 <?php echo $Data ['PageSize'];?> 条 <a href="<?php echo UrlRewriteSimple($MyModule,'GbaopenCost',true);?>">首页</a> <a href="<?php if($Data['Page']>1){echo UrlRewriteSimple($MyModule,'GbaopenCost',true).'&Page='.($Data['Page']-1);}else{echo '#';}?>">上一页</a> <a href="<?php if($Data['Page']<$Data['RecordCount']){echo UrlRewriteSimple($MyModule,'GbaopenCost',true).'&Page='.($Data['Page']+1);}else{echo '#';}?>">下一页</a> <a href="<?php if($Data['Page']<$Data['RecordCount']){echo UrlRewriteSimple($MyModule,'GbaopenCost',true).'&Page='.$Data['PageCount'];}else{echo '#';}?>">尾页</a> 跳转到
...
function ToPage(PageCount){
   ...
   location.href = "<?php echo UrlRewriteSimple($MyModule,'GbaopenCost',true).'&Page=';?>"+pages;
}
</script></td>
              </tr>
            </tfoot>
