...
(function(root, factory) {
    ...
    var defaults = {
        ...
        selectedRang: ['2015/09/01', new Date()],
    ...
    Calendar.prototype = {
        ...
        getParentPos: function(e) {
            var eP = e.parent();
            if (eP.css('position') == 'fixed')
                return true;
            else if (eP.prop("tagName") == 'BODY') {
                return false
            } else {
                return this.getParentPos(eP);
            }
        },
        ...
        trigger: function() {
            ...
            var _this = this,
                    ...
                    pos = _this.getParentPos(_this.$trigger) ? 'fixed' : 'absolute';
