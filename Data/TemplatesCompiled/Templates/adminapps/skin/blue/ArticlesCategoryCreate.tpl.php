...
/*
 ...
 compiled from ArticlesCategoryCreate.htm at 2010-01-07 01:47:01 Asia/Shanghai
*/
...
<div class="UserBodyTitle">新增/编辑分类</div>
...
<div style="padding-left: 100px; line-height: 50px; height: 50px;"><input
    ...
    <?php if($Detail) { ?>    <input name="CategoryID" type="hidden" value="<?php echo $Detail[CategoryID];?>" />
    <?php } ?>    </div>
