...
/*
 ...
 compiled from LinksCategoryIndex.htm at 2010-01-07 01:47:01 Asia/Shanghai
*/
...
<div class="UserBodyTitle">外链目录列表</div>
<div class="font-12px">
<div style="line-height: 25px;">当前目录: <a
	href="<?php echo UrlRewriteSimple('Category','Index'); ?>">Top</a> 
<?php $__view__data__0__=$Location;if(is_array($__view__data__0__)) { foreach($__view__data__0__ as $l) { ?>
&nbsp;/&nbsp; <a
	href="<?php echo UrlRewriteSimple('Category','Index'); ?>&ParentCategoryID=<?php echo $l[CategoryID];?>"><?php echo $l[CategoryName];?></a>
<?php } } ?>
</div>
