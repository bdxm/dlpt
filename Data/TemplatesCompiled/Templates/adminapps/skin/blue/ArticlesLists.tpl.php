...
/*
 ...
 compiled from ArticlesLists.htm at 2010-01-07 01:47:01 Asia/Shanghai
*/
?><html>
<head>
...
<div class="UserBodyTitle">旅游游记管理</div>
<div class="font-12px">
...
<?php } } ?>
 ...
 <input name="button2" type="submit" class="btn" id="button2" value="设置分类" onclick="this.form.action.value='Setting'" />			  
