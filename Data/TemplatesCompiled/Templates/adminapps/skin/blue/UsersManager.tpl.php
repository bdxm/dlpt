...
/*
 ...
 compiled from UsersManager.htm at 2010-01-07 01:47:01 Asia/Shanghai
*/
...
<div class="UserBodyTitle">用户管理</div>
<div class="font-12px">
...
<div class="left">查询结果: 共 <?php echo $UserList[RecordCount];?>个用户&nbsp;&nbsp;&nbsp;第 <?php echo $UserList[Page];?>/<?php echo $UserList[PageCount];?> 页.</div>
<div class="right"><?php if($UserList[FirstPage]) { ?><a
...
<form id="form1" name="form1" method="GET"
	action="<?php echo UrlRewriteSimple('Users','Manager',true); ?>">
<div class="line-border-f0f0f0">
<div class="UserBodyTitle">搜索</div>
<div class="font-12px">
<table width="100%" border="0" cellspacing="0" cellpadding="5">
	<tr>
...
<div style="padding-top: 20px; padding-left: 30px;"><input
