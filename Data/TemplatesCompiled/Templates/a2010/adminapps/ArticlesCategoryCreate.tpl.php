...
/*
 ...
 compiled from ArticlesCategoryCreate.htm at 2010-01-21 17:37:14 Asia/Shanghai
*/
...
<body>
<form action="<?php echo UrlRewriteSimple('ArticlesCategory','CreateSave',true); ?>"
	method="post" name="form1" id="form1">
<div class="panel">
  <div class="panel-header">
    <div class="panel-header-left"></div>
    <div class="panel-header-content">新增/编辑分类</div>
  ...
  <div class="panel-body">
	...
	<tr>
		...
		<td><input name="CategoryName" type="text"
			class="input-notsize-style" id="CategoryName" value="<?php echo self::__htmlspecialchars($Detail[CategoryName]); ?>" /></td>
		</tr>
        <tr>
...
<?php $__view__data__0__=$data;if(is_array($__view__data__0__)) { foreach($__view__data__0__ as $list) { ?>
			<option value="<?php echo $list[CategoryID];?>" <?php if($Detail[ParentCategoryID]==$list[CategoryID]) { ?>selected="selected"<?php } ?>>&nbsp;&nbsp;<?php echo str_repeat('&nbsp;',$list[Level]*3); ?>|- <?php echo $list[CategoryName];?></option>
...
<?php } } ?>
	...
	<tr>
	  ...
	  <td><input name="Alias" type="text"
			class="input-notsize-style" id="Alias" value="<?php echo $Detail[Alias];?>" /></td>
	  </tr>
	<tr>
		<td align="right">同级排序:</td>
		<td><input name="DisplayOrder" type="text"
			class="input-notsize-style" id="DisplayOrder" value="<?php echo self::__htmlspecialchars($Detail[DisplayOrder]); ?>" />
		  </td>
	</tr>
</table>
        </div>
...
<div style="padding-left: 100px; line-height: 50px; height: 50px;"><input
    ...
    <input name="CategoryID" type="hidden" value="<?php echo $Detail[CategoryID];?>" />
    </div>
