...
/*
 ...
 compiled from PropertyAdd.htm at 2014-03-31 23:16:24 Asia/Shanghai
*/
  ...
  <div class="panel-body">
   ...
   <table width="100%" border="0" cellspacing="0" cellpadding="5">
	...
	<tr>
	  ...
	  <td><select name="ProjectPropertyParentID" id="ProjectPropertyParentID">
          <option value="0" <?php if($PropertyPropertyInfo[ProjectPropertyParentID]==0) { ?>selected<?php } ?>>顶级属性</option>
          
<?php $__view__data__0__=$ParentData;if(is_array($__view__data__0__)) { foreach($__view__data__0__ as $ParenList) { ?>
          <option value="<?php echo $ParenList[PropertyPropertyID];?>" <?php if($PropertyPropertyInfo[ProjectPropertyParentID]==$ParenList[PropertyPropertyID]) { ?>selected<?php } ?>><?php echo $ParenList[PropertyPropertyName];?></option>
